...
## 📋 File Info
- **Output file**: `data/output/reverend-insanity/reverend-insanity_0012.mm.md`
- **Novel**: reverend-insanity
- **Chapter**: 12
- **Pipeline**: unknown
- **Model**: unknown
- **Duration**: 0s
- **Reviewed at**: 2026-05-02T03:02:03.468155
...
| Content Completeness | ✅ | -0 | 11895 chars, no errors |
| Paragraph Structure | ✅ | -0 | 99 breaks, 102 content lines |
| Archaic Words | ⚠️ | -10 | Found: ဤ(7), ထို(21) — use modern alternatives |
| Particle Repetition | ✅ | -0 | No hallucination loops |
| Register Consistency | ✅ | -0 | Register appears consistent |
| Sentence Enders | ✅ | -0 | 1 lines without enders — acceptable |

## 🟡 WARNINGS (Should Fix)
- [ ] Found: ဤ(7), ထို(21) — use modern alternatives
...
- Content Completeness: 11895 chars, no errors
- Paragraph Structure: 99 breaks, 102 content lines
- Particle Repetition: No hallucination loops
- Register Consistency: Register appears consistent
- Sentence Enders: 1 lines without enders — acceptable
