...
## 📋 File Info
- **Output file**: `data/output/dao-equaling-the-heavens/dao-equaling-the-heavens_chapter_013.mm.md`
- **Novel**: dao-equaling-the-heavens
- **Chapter**: 13
- **Pipeline**: unknown
- **Model**: unknown
- **Duration**: 0s
- **Reviewed at**: 2026-05-04T11:42:20.153408
...
| Content Completeness | ✅ | -0 | 12570 chars, no errors |
| Paragraph Structure | ✅ | -0 | 76 breaks, 76 content lines |
| Archaic Words | ⚠️ | -10 | Found: ဤ(5), ထို(12) — use modern alternatives |
| Particle Repetition | ✅ | -0 | No hallucination loops |
| Register Consistency | ⚠️ | -10 | Mixed registers: 146 formal + 92 casual particles |
| Sentence Length | ✅ | -0 | No overlong sentences |
| Sentence Enders | ⚠️ | -5 | 7 lines without sentence-enders — possible truncation |
...
- [ ] Mixed registers: 146 formal + 92 casual particles
- [ ] 7 lines without sentence-enders — possible truncation
...
- Content Completeness: 12570 chars, no errors
- Paragraph Structure: 76 breaks, 76 content lines
