...
GLOBAL_TERMS: list[tuple] = [
    ...
    ("dao", "လမ်းစဥ်", "cultivation_concept", "hard"),
    ("Dao", "လမ်းစဥ်", "cultivation_concept", "hard"),
    ("Heavenly Dao", "ကောင်းကင်လမ်းစဥ်", "cultivation_concept", "hard"),
    ("heavenly dao", "ကောင်းကင်လမ်းစဥ်", "cultivation_concept", "hard"),
    ("meridian", "မယ်ရီဒီယန်", "cultivation_concept", "hard"),
    ("meridians", "မယ်ရီဒီယန်များ", "cultivation_concept", "hard"),
    ("dantian", "ဒန်တန်", "cultivation_concept", "hard"),
    ("cultivation", "ကျင့်ကြံ", "cultivation_concept", "hard"),
    ("cultivator", "ကျင့်ကြံသူ", "cultivation_concept", "hard"),
    ("cultivation base", "ကျင့်ကြံမှုအခြေခံ", "cultivation_concept", "hard"),
    ("immortal cultivation", "မသေမျိုးကျင့်ခြင်း", "cultivation_concept", "hard"),
    ("immortal", "မသေမျိုး", "cultivation_concept", "hard"),
    ("become an immortal", "မသေမျိုးဖြစ်လာခြင်း", "cultivation_concept", "hard"),
    ("living forever", "ထာဝရအသက်ရှည်ခြင်း", "cultivation_concept", "hard"),
    ("quick-witted", "လိမ္မာပါးမာ", "character", "soft"),
    ("impurities", "အညစ်အကြေး", "cultivation_concept", "hard"),
    ("impurity", "အညစ်အကြေး", "cultivation_concept", "hard"),
    ("filth", "အညစ်အကြေး", "cultivation_concept", "hard"),
    ("breakthrough", "အတားအဆီးကျော်လွန်ခြင်း", "cultivation_concept", "hard"),
    ("bottleneck", "ပိတ်ဆို့မှု", "cultivation_concept", "hard"),
    ("tribulation", "ဆိုးကျိုးသက်ရောက်မှု", "cultivation_concept", "hard"),
    ("heavenly tribulation", "ကောင်းကင်ဘုံ၏ ကပ်ဘေး", "cultivation_concept", "hard"),
    ...
    ("Qi Condensation", "ချီ စုဆောင်းခြင်း", "power_level", "hard"),
    ("Foundation Establishment", "အခြေခံ အုတ်မြစ်တည်ဆောက်ခြင်း", "power_level", "hard"),
    ("Core Formation", "ဗဟိုချက်ဖွဲ့စည်းခြင်း", "power_level", "hard"),
    ("Golden Core", "ရွှေဗဟိုချက်ခြင်း", "power_level", "hard"),
    ("Nascent Soul", "မွေးကင်းစဝိညာဉ်ခြင်း", "power_level", "hard"),
    ("Soul Formation", "ဝိညာဉ်ဖွဲ့စည်းခြင်း", "power_level", "hard"),
    ("Spirit Severing", "ဝိညာဉ်ဖြတ်တောက်ခြင်း", "power_level", "hard"),
    ("Dao Seeking", "တရားရှာဖွေခြင်း", "power_level", "hard"),
    ("Immortal Ascension", "နတ်ဘုရားဖြစ်ခြင်း", "power_level", "hard"),

    # ── Common Items ──
    ("spirit stone", "ဝိညာဉ်ကျောက်", "item_artifact", "hard"),
    ("spirit stones", "ဝိညာဉ်ကျောက်များ", "item_artifact", "hard"),
    ("spirit rice", "ဝိညာဉ်ဆန်စပါး", "item_artifact", "hard"),
    ...
    ("magic treasure", "မှောရတနာ", "item_artifact", "hard"),
    ("flying sword", "ဓားပျံ", "item_artifact", "hard"),
    ...
    ("talisman", "သင်္ကေတ", "item_artifact", "hard"),
    ...
    ("pavilion", "ပြခန်း", "organization", "hard"),
    ...
    # ── Common Titles ──
    ("elder", "အကြီးအကဲ", "title_honorific", "hard"),
    ...
    ("inner disciple", "အတွင်းစည်း တပည့်", "title_honorific", "hard"),
    ("outer disciple", "အပြင်စည်း တပည့်", "title_honorific", "hard"),
    ("core disciple", "ဗဟိုတပည့်", "title_honorific", "hard"),
    ("senior brother", "အစ်ကိုကြီး", "title_honorific", "hard"),
    ("junior brother", "ဂျူနီယာ ညီလေး", "title_honorific", "hard"),
    ("Ninth Junior Brother", "နဝမမြောက် ဂျူနီယာ ညီလေး", "title_honorific", "hard"),
    ("senior sister", "အစ်မကြီး", "title_honorific", "hard"),
    ("junior sister", "ဂျူနီယာ ညီမငယ်", "title_honorific", "hard"),
    ("young master", "လူငယ်သခင်", "title_honorific", "hard"),
    ("young miss", "သခင်မလေး", "title_honorific", "hard"),
    ("sect leader", "ဂိုဏ်းခေါင်းဆောင်", "title_honorific", "hard"),
    ("hall master", "ခန်းမခေါင်းဆောင်", "title_honorific", "hard"),
    ("peerless", "အတုယှဉ်မဲ့", "title_honorific", "hard"),
    ("Venerable", "အရှင်မြတ်", "title_honorific", "hard"),
    ("Venerable One", "အရှင်မြတ်", "title_honorific", "hard"),
    ("Expert", "ကျွမ်းကျင်သူ", "title_honorific", "hard"),
    ("Senior", "စီနီယာ", "title_honorific", "hard"),
    ("Junior", "ဂျူနီယာ", "title_honorific", "hard"),
    ...
    ("divine ability", "နတ်စွမ်းအင်", "technique", "hard"),
    ...
    ("cave abode", "ဂူအိမ်", "location", "hard"),
    ...
    # ── Common Creatures ──
    ("demon beast", "နတ်ဆိုးသားရဲ", "creature", "hard"),
    ("spirit beast", "ဝိညာဉ်သားရဲ", "creature", "hard"),
    ("magical beast", "မှော်သား", "creature", "hard"),
    ("monster", "သားရဲ", "creature", "hard"),
