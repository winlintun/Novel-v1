...
GLOBAL_TERMS: list[tuple] = [
    ...
    ("immortal cultivation", "နတ်ကျင့်ခြင်း", "cultivation_concept", "hard"),
    ("immortal", "နတ်သား", "cultivation_concept", "hard"),
    ("become an immortal", "နတ်သားဖြစ်ခြင်း", "cultivation_concept", "hard"),
    ...
    ("Ninth Junior Brother", "နဝမမြောက် တပည့်ညီ", "title_honorific", "hard"),
